                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            ?>
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="exampleModal<?= $data['code'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Book Form</h1>
