...
$ddlAllowanceType = OCodeField::GetDropDownListCodeFieldByCodeType(OCodeField::$ALLOWANCE_TYPE, $sessionId);
...
<body class="frame">
    <form id="VIEW" action="" method="post" BaseTableName="Allowance">
        <gridview id="gvDetails" TableName="Allowance">
            <grid-command>
    ...
    <form id="EDIT" action="" method="post" BaseTableName="Allowance" Save="SaveObject">
        ...
        <div class="row">
            <div class="two-col">
                <dropdownlist id="ddlAllowanceType" name="->AllowanceTypeID" Caption="Allowance Type" Load="ddlAllowanceType" required="true">
                    <option value=""></option>
                </dropdownlist>
            </div>
            <div class="two-col">
